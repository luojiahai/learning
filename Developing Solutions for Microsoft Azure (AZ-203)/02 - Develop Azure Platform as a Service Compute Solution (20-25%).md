...
- [Add Push Notifications to your iOS App](https://docs.microsoft.com/en-us/previous-versions/azure/app-service-mobile/app-service-mobile-ios-get-started-push)
...
- [Create a function in Azure using Visual Studio Code (Python)](https://docs.microsoft.com/en-us/azure/azure-functions/functions-create-first-function-vs-code?pivots=programming-language-python)